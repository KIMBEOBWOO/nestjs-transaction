...
export const TYPEORM_ENTITY_MANAGER_QUERY_RUNNER_NAME =
  '@nestjs-transaction/entity-manager-query-runner';

export const TRANSACTION_EVENT_EMIMTTER = '@nestjs-transaction/event-emitter';
